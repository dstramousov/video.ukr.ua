...
return array(
    ...
    Zend_Validate_Ccnum::LENGTH                     => '"%value%" должно быть чисельным значением от 13 до 19 цифр длинной',
    ...
    Zend_Validate_GreaterThan::NOT_GREATER          => '"%value%" не является большим за "%min%"',
    
    Zend_Validate_Hex::NOT_HEX                      => '"%value%" местит в себе не только шестнадцатеричные символы',
    ...
    Zend_Validate_Hostname::INVALID_LOCAL_NAME      => '"%value%" - адрес является недопустимым сетевым названием местности',
    Zend_Validate_Hostname::LOCAL_NAME_NOT_ALLOWED  => '"%value%" - адрес является сетевым названием местности, но сетевые названия местности не разрешены',
    ...
    Zend_Validate_Int::NOT_INT                      => '"%value%" не является целочисельным значением',
    ...
    Zend_Validate_NotEmpty::IS_EMPTY                => 'Значение поля не задано',
    
    //Zend_Validate_Regex::NOT_MATCH                  => 'Значение "%value%" не подходит под шаблон регулярного выражения "%pattern%"',
    
    Zend_Validate_StringLength::TOO_SHORT           => 'Длинна введённого значения "%value%", меньше чем %min% симв.',
    Zend_Validate_StringLength::TOO_LONG            => 'Длинна введённого значения "%value%", больше чем %max% симв.',
    Zend_Captcha_Word::MISSING_VALUE                => 'Символы не введены',
    Zend_Captcha_Word::MISSING_ID                   => 'Не задано поле ID Captcha',
    Zend_Captcha_Word::BAD_CAPTCHA                  => 'Символы введены неверно',
